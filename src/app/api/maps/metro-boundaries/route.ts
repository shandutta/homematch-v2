...
export async function GET(request: Request) {
  ...
  const neighborhoods = (data || []) as NeighborhoodRow[]
...
function buildMeceNeighborhoods(rows: NeighborhoodRow[]) {
...
function simplifyRingAdaptive(ring: LatLng[]): LatLng[] {
...
function toGeoJsonMultiPolygon(polygons: PolygonRings[]) {
  return {
    type: 'MultiPolygon',
