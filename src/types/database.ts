  ...
  public: {
    Tables: {
      ...
      property_vibes: {
        ...
        Relationships: [
          {
            foreignKeyName: 'property_vibes_property_id_fkey'
            columns: ['property_id']
            isOneToOne: true
            referencedRelation: 'properties'
            referencedColumns: ['id']
    ...
    Functions: {
      ...
      check_table_exists: { Args: { table_names: string[] }; Returns: Json }
      ...
      get_household_activity_enhanced: {
        Args: { p_household_id: string; p_limit?: number; p_offset?: number }
        Returns: {
          created_at: string
          id: string
          interaction_type: string
