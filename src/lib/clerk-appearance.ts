...
export const clerkAppearance: Appearance = {
  ...
  elements: {
    ...
    formFieldInput:
      'bg-white/5 border border-white/10 text-white placeholder:text-white/40 focus:border-sky-400/60 focus:ring-sky-400/20',
    formFieldInputShowPasswordButton: 'text-white/60 hover:text-white',
    formButtonPrimary:
      'bg-gradient-to-b from-[#0c1426] to-[#0a0f1d] hover:from-[#0e1730] hover:to-[#0c1426] text-white font-semibold shadow-[0_2px_8px_rgba(0,0,0,0.35)] ring-1 ring-sky-400/30 hover:ring-sky-400/50',
