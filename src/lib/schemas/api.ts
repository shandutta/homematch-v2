...
export const propertySearchQuerySchema = z.object({
  ...
  bedrooms_min: z.string().optional().transform((val) => val ? parseInt(val, 10) : undefined),
  bedrooms_max: z.string().optional().transform((val) => val ? parseInt(val, 10) : undefined),
  bathrooms_min: z.string().optional().transform((val) => val ? parseFloat(val) : undefined),
  bathrooms_max: z.string().optional().transform((val) => val ? parseFloat(val) : undefined),
  property_types: z.string().optional().transform((val) => val ? val.split(',') : undefined),
  neighborhoods: z.string().optional().transform((val) => val ? val.split(',') : undefined),
})
...
export const marketingPropertiesResponseSchema = z.array(marketingPropertySchema)
...
export type MarketingPropertiesResponse = z.infer<typeof marketingPropertiesResponseSchema>
