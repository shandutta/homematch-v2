...
export class PropertyCrudService extends BaseService {
  ...
  async getPropertyWithNeighborhood(propertyId: string): Promise<PropertyWithNeighborhood | null> {
    ...
    return this.executeQuery(
      ...
      async (supabase) => {
        ...
        if (error) {
          throw new DatabaseError('Failed to fetch property with neighborhood', { propertyId, error })
        }
  ...
  async createProperty(property: PropertyInsert): Promise<Property | null> {
    ...
    return this.executeQuery(
      ...
      async (supabase) => {
        ...
        if (error) {
          throw new DatabaseError('Failed to create property', { property, error })
        }
    ...
    return this.executeQuery(
      ...
      async (supabase) => {
        ...
        if (error) {
          ...
          throw new DatabaseError('Failed to update property', { propertyId, updates, error })
        }
    ...
    return this.executeQuery(
      ...
      async (supabase) => {
        ...
        if (error) {
          ...
          throw new DatabaseError('Failed to delete property', { propertyId, error })
        }
    ...
    return this.executeQuery(
      ...
      async (supabase) => {
        ...
        if (error) {
          ...
          throw new DatabaseError('Failed to fetch property by ZPID', { zpid, error })
        }
    ...
    return this.executeQuery(
      ...
      async (supabase) => {
        ...
        if (error) {
          ...
          throw new DatabaseError('Failed to fetch property by hash', { hash, error })
        }
   ...
   */
  private validatePropertyData(property: PropertyInsert | PropertyUpdate): void {
    ...
    if ('square_feet' in property && property.square_feet !== undefined && property.square_feet !== null) {
 ...
 */
export function createPropertyCrudService(clientFactory?: ISupabaseClientFactory): PropertyCrudService {
