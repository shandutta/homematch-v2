    ...
    if (type === 'liked') {
      return (
        <button
          ...
          className="group relative flex h-12 w-12 scale-110 items-center justify-center overflow-hidden rounded-full border border-rose-300 bg-rose-600 text-white shadow-lg ring-2 ring-rose-300/50 transition-[width,background-color] duration-200 ease-out hover:w-[10.5rem] focus-visible:w-[10.5rem] focus-visible:outline-none disabled:opacity-60"
          disabled={isRemoving}
          onClick={(e) => {
            e.stopPropagation()
    ...
    if (type === 'skip') {
      return (
        <button
          ...
          className="group relative flex h-12 w-12 scale-110 items-center justify-center overflow-hidden rounded-full border border-emerald-300 bg-emerald-600 text-white shadow-lg ring-2 ring-emerald-300/50 transition-[width,background-color] duration-200 ease-out hover:w-[10.5rem] focus-visible:w-[10.5rem] focus-visible:outline-none disabled:opacity-60"
      ...
      return (
        <div className="flex items-center gap-2">
          <button
            ...
            className={`group relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-full border shadow-lg transition-all duration-200 ease-out focus-visible:outline-none disabled:opacity-60 ${
              isPassSelected
