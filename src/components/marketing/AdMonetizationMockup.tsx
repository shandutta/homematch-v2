        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          {adConcepts.map((concept, index) => {
            ...
            return (
              ...
              >
                <Card className="group shadow-md hover:shadow-lg flex h-full flex-col rounded-2xl border border-slate-200 bg-white transition-all duration-200 hover:-translate-y-1">
