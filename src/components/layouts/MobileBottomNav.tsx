...
export function MobileBottomNav({ className }: MobileBottomNavProps) {
  ...
  return (
    <nav
      className={cn(
        'bottom-nav safe-area-bottom border-hm-border/70 bg-hm-surface/95 fixed inset-x-0 bottom-0 z-50 border-t shadow-[0_-10px_28px_rgba(52,43,37,0.10)] backdrop-blur-xl md:hidden',
        className
      )}
      aria-label="Primary"
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? 'bg-hm-surface text-hm-ink shadow-[0_8px_20px_rgba(52,43,37,0.10)]'
                  : 'text-hm-muted hover:bg-hm-surface/70 hover:text-hm-ink'
              )}
              aria-label={
            ...
            >
              <Icon
                className={cn(
                  ...
                  isActive ? 'text-hm-accent-strong' : 'text-hm-muted'
                )}
                strokeWidth={2}
              />
