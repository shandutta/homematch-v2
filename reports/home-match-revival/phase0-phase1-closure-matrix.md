...
- Blocked/decision-needed: real service-role RBAC model; durable rate-limiter decision; numeric constraint semantics; DB reset/lint/integration environment; disputed-route email/profile field exposure decision. Production email confirmation/CAPTCHA is policy-decided by `reports/home-match-revival/d3-signup-verification-policy-decision-2026-05-08.md`, but approved external/config implementation and local/E2E environment setup remain blocked. See `reports/home-match-revival/p1-decision-needed-register-2026-05-08.md` and `reports/home-match-revival/p0-p1-blocker-reconciliation-2026-05-08.md` for the concise owner-decision register and blocker reconciliation.
