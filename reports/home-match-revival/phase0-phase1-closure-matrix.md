...
- Open: auth client consolidation partial; interactions service-role fallback; duplicate auth getUser monkey-patching; E2E auth lifecycle; query dedupe; realtime N+1; rollback/DOWN scripts; user_profiles DELETE policy; households INSERT policy; JSONB indexes; inline DB typing cleanup; external-call timeout cleanup; remaining local-dev validation blockers; remaining dependency cleanup decision.
