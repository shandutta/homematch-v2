...
- Open: auth client consolidation partial; interactions service-role fallback; duplicate auth getUser monkey-patching; E2E auth lifecycle; query dedupe; realtime N+1; rollback/DOWN scripts; inline DB typing cleanup; remaining dependency cleanup decision; duplicate rate-limit system consolidation.
