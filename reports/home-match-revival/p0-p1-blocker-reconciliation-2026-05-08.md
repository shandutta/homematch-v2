...
| D7 disputed-route email/profile exposure | approval-needed | Register D7 and DB P1.6: disputed route still selects/returns email/profile fields. | Product/security chooses whether email is required; then a small route/RPC slice can follow. |
...
2. Draft implementation acceptance criteria for D5 or D7 after Shan/product/security chooses an option. Do not implement before the decision.
