...
- duplicate the operator-tooling roadmap in
  `admin-tooling-gap-index-2026-05-08.md` — that file owns the _gap_ view;
  this file owns the _side-effect / credential surface_ view of the routes
  that already exist.
...
- **Identity gate is rate-limit + cron-secret only.** None of these routes
  ...
  `admin-tooling-gap-index-2026-05-08.md` §2.1 and is _not_ re-litigated
  here.
