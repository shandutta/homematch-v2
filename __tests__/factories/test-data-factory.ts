...
export const createMockPropertyWithNeighborhood = (overrides?: Partial<Property & { neighborhood?: Neighborhood | null }>): Property & { neighborhood?: Neighborhood | null } => ({
  ...createMockProperty(),
...
export const createMockInteraction = (overrides?: Partial<UserPropertyInteraction>): UserPropertyInteraction => ({
  id: faker.string.uuid(),
...
export const createMockHousehold = (overrides?: Partial<Household>): Household => ({
  ...
  collaboration_mode: faker.helpers.arrayElement(['independent', 'shared', 'weighted']),
  created_at: faker.date.past().toISOString(),
  updated_at: faker.date.recent().toISOString(),
  ...overrides
});

export const createMockSavedSearch = (overrides?: Partial<SavedSearch>): SavedSearch => ({
  id: faker.string.uuid(),
  user_id: faker.string.uuid(),
  household_id: faker.string.uuid(),
