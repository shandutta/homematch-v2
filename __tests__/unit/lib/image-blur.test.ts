import { generateBlurDataURL, getPropertyBlurPlaceholder, PROPERTY_BLUR_PLACEHOLDERS } from '@/lib/image-blur'
...
describe('image-blur utilities', () => {
  ...
  describe('getPropertyBlurPlaceholder', () => {
    test('returns house-1 placeholder for house-1 images', () => {
      const result = getPropertyBlurPlaceholder('/images/house-1-living-room.jpg')
    ...
    test('matches house patterns anywhere in path', () => {
      const result1 = getPropertyBlurPlaceholder('/some/deep/path/house-1-bathroom.jpg')
      const result2 = getPropertyBlurPlaceholder('https://example.com/house-2-exterior.jpg')
