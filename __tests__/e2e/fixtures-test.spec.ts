...
test('Basic Fixtures - should load page and use utils', async ({ page, utils, logger }) => {
...
test('Basic Fixtures - should handle navigation with retry', async ({ page, utils, retry, logger }) => {
...
test('Basic Fixtures - should check authentication state', async ({ page, utils, config, logger }) => {
