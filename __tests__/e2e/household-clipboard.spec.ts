...
test.describe('Household Clipboard Functionality', () => {
  ...
  // This test requires a user without household (test3@example.com) which is seeded by setup-test-users-admin.js
  test('copy button is not visible without household', async ({
    page,
  }) => {
