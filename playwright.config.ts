...
export default defineConfig({
  ...
  webServer: {
    ...
    env: {
      ...
      NEXT_PUBLIC_SUPABASE_ANON_KEY: process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY || 'REDACTED_SUPABASE_ANON_KEY',
      SUPABASE_SERVICE_ROLE_KEY: process.env.SUPABASE_SERVICE_ROLE_KEY || 'REDACTED_SUPABASE_SERVICE_ROLE_KEY',
    },
  },
})
